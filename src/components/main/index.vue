                            ...
                            <div class="logo-pannel">
                                <el-row :gutter="10">
                                    <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="8">
                                        <div class="logo">
                                            <img src="../../upload/images/img20180906144044.jpeg" />
                                        </div>
                                    </el-col>
                                    ...
                                    <div class="direct-chat-msg" v-for="msg in basicInfo.messages" :key="msg._id">
                                        <div class="direct-chat-info clearfix">
                                            <span class="direct-chat-name pull-left">
                                                ...
                                                在
                                                <a class="direct-chat-contentTitle" :href="'/details/'+msg.contentId._id+'.html'" target="_blank">{{msg.contentId.stitle | cutWords(25)}}</a> {{msg.utype =='0'?'说':'回复'}}
  ...
  computed: {
    ...
    renderLogs() {
      ...
      if (this.basicInfo.loginLogs && this.basicInfo.loginLogs[0]) {
        logs = {
          ip: this.basicInfo.loginLogs[0].logs.split(":")[4],
