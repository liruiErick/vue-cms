<template>
    <div class="dr-AdminResourceForm">
        <el-dialog width="35%" size="small" :title="$t('adminResource.lb_resourceForm_title')" :visible.sync="dialogState.show" :close-on-click-modal="false">
            <el-form :model="dialogState.formData" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                ...
                <el-form-item :label="$t('adminResource.lb_type')" prop="type">
                    <el-select size="small" v-model="dialogState.formData.type" :placeholder="$t('main.ask_select_label')" @change="changeType">
